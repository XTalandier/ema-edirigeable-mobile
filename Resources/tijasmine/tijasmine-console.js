function ConsoleReporter(finishCallback) {
    ...
    var startedAt, runningSuite, failureRecaps, topLevelSuites, logPrefix = "[JASMINE]", separatorLength = 60, levelIndentation = 3, sep = Array(separatorLength + 1).join("-"), bigsep = Array(separatorLength + 1).join("="), failedCount = 0, passedCount = 0;
